...
#coding=utf-8
"""--------------------------------------------
#   Script is by Mrvenom01
#	   Originally written by Mrvenom01
#		   Free CREDIT MRVENOM01
#--------------------------------------------"""
...
{}
      GITHUB    : Mrvenom01 
      Extract Tools By Mrvenom01
      Version (0.1) | Free For My All User 
{}'''.format('\n',50*'-',50*'-')
...
class login():
	...
	def lo_epa(self):
		...
		if 'access_token' in po:
			...
			exit('run again python Extract.py')
		else:
...
def divider():
	...
	with open(filename, 'r',encoding='utf-8') as f:
		...
		for i in range(int(limit)):
			POP = i * DATEE
			POP2 = POP + DATEE
			with open("vnm_{}_{}.txt".format(str(''.join(random.choices(string.ascii_letters.lower(), k=2))),i), 'w',encoding='utf-8') as out_file:
